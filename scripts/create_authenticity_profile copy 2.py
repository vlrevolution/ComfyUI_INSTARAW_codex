...
# (Definitive Version 4.0 - With Metadata Blacklist)
...
# --- NEW: Blacklist for file-specific tags that should not be copied ---
METADATA_BLACKLIST = [
    # File-system specific tags
    'SourceFile',
    'File:FileName',
    'File:Directory',
    'File:FileModifyDate',
    ...
    # Binary data that is complex and often not needed
    'ICC_Profile:RedTRC',
    'ICC_Profile:BlueTRC',
...
def get_metadata_with_exiftool(filepath: str) -> dict:
    """
    Extracts all metadata, preserving group prefixes, and filters out
    file-specific tags that should not be transferred.
    """
    clean_metadata = {}
    try:
...
def main():
    ...
    parser.add_argument("--analysis-resolution", type=int, default=2048, help="Resize images to this max dimension for spectral analysis. 0 for full-res (slow).")
    ...
    metadata_library = [r['metadata'] for r in all_results if r['metadata']]
