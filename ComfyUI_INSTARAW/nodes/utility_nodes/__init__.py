...
from .lens_simulation_node import (
    NODE_CLASS_MAPPINGS as LENS_SIM_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as LENS_SIM_DISPLAY_MAPPINGS,
)
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **LENS_SIM_DISPLAY_MAPPINGS, # ADD THIS
}
